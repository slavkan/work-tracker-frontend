...
import NavbarProfessor from "@/app/components/NavbarSupervisor";
import { PageLoading } from "@/app/components/PageLoading";
import Link from "next/link";
import styles from "@/app/supervisor/profile/styles.module.css";
...
function page() {
  ...
  return (
    <div>
      <NavbarProfessor token={token} departmentsChanged={false} />
